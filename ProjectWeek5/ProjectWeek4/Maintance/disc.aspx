        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Release Date" SortExpression="release_date">
                <EditItemTemplate>
                    ...
                    <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Enter valid date" 
                        ControlToValidate="TextBox2" Display="Dynamic" Type="Date" ValidationGroup="Edit" 
